...
import function_binary_xnor_convolution_2d


class BinaryXnorConvolution2D(link.Link):
    ...
    def __init__(self, in_channels, out_channels, ksize, stride=1, pad=0,
        ...
        super(BinaryXnorConvolution2D, self).__init__(W=W_shape)
    ...
    def __call__(self, x):
        ...
        """
        return function_binary_xnor_convolution_2d.binary_xnor_convolution_2d(
